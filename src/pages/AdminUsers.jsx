...
import { 
  Shield, Users, Clock, Calendar, Mail, FileText, X, ArrowUpRight, ArrowDownLeft, Wallet, Trash2
} from 'lucide-react';
...
export default function AdminUsers() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to retrieve user accounts logs.');
      }
      ...
      console.error(err);
      setError(err.message || 'Error loading user directories.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleInspectUser = async (userObj) => {
    ...
    try {
      ...
      console.error(err);
      alert('Error fetching user ledger files.');
    } finally {
    ...
    <div className="admin-page-container">
      ...
      <div className="admin-header">
        <div className="admin-title-box">
          ...
          <div>
            <h1 className="admin-title-main">Registered User Directory</h1>
            <p className="admin-title-sub">Superadmin view only — audit user profiles and transaction ledgers</p>
          </div>
        </div>
      ...
      <div className="admin-data-card">
        {loading ? (
          <div className="admin-loader-box">
            ...
            <p>Fetching user profiles database...</p>
          </div>
        ) : (
          <div>
            ...
            <div className="admin-modal-body">
              {loadingTransactions ? (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '4rem 0', gap: '1rem', color: '#94a3b8' }}>
                  <div style={{ width: '40px', height: '40px', borderRadius: '50%', border: '3px solid rgba(59, 130, 246, 0.1)', borderTopColor: '#3b82f6', animation: 'spin 1s linear' }} />
